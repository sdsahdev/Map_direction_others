package com.example.array.imagepick;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position < mArrayUri.size() - 1) {
                    ...
                    Toast.makeText(ImagepickerActivity.this, "Last Image Already Shown", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//
//                    FeedPostImage productImage = new FeedPostImage();
//
//                    productImage.setType("local");
//
